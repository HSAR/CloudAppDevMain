                                    ...
                                    if action_note_length > 0:
                                        ...
                                        if len(track) > 0:
                                            ...
                                            if note_unique:
                                                ...
                                                # We need to remove notes which could be occupying the position of this
                                                # newly added note.
                                                # Loop through each note and remove it if it gets in the way
                                                for note in notes:
                                                    ...
                                                    if not (
                                                                current_end <= note_start or current_start >= note_end or current_pitch != note_pitch):
                                                        notes.remove(note)
                                        ...
                                        logging.warning(
                                            'A non positive length was provided: ' + str(action_note_length))
                                else:
                                    logging.warning(
                                        'A note number was not in the valid range: ' + str(action_note_pitch))
                            else:
