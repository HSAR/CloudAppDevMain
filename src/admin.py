...
class InitialDataLoader(webapp2.RequestHandler):
    def get(self):
        ...
        jingle = Jingle(id='0', jingle_id='0', title='Merry Chistmas', author='114163773958786510855',
                        genre='Snow Clouds', tags=['Santa', 'Rudolf', 'Tinsel, fool'])
        jingle_json = {}
...
application = webapp2.WSGIApplication([
                                          ...
                                          webapp2.Route(r'/_ah/channel/disconnected/', handler=ChannelDisconnect,
                                                        name='chan-disconnect'),
                                          webapp2.Route(r'/admin/initialdata', handler=InitialDataLoader,
                                                        name='initial_data'),
                                      ], debug=True)
